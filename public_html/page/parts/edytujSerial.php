<?php
	...
	if($Connect->connect_errno != 0)
	{
		...
		$flag = true;
		$error = 0;
		if(empty($name1) || empty($description1) || empty($year1) || empty($image1) ||  empty($filmewb1) || empty($category1) || empty($versionFilm1)){
			$flag = false;
			$error = 1;
		}
		...
		if($flag == true){
			...
			if($res2 = $Connect->query("UPDATE serials SET name = '$name1' , description = '$description1' , data = '$year1' ,  image = '$image1' , 
...
<div id="formFilm">
	<div id="descReg">Edycja serialu</div>
	<form method="post">
